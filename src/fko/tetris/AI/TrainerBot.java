 ...
 */
public class TrainerBot extends AbstractBot {
	 ...
	 * @param game
	 */
	public TrainerBot(TetrisGame game) {
		super(game);
	}
	...
	private void placeTetrimino() {
		...
		long time = System.nanoTime();
		_trainingData.appendEntry(myMatrix.clone(), myMatrix.getCurrentTetrimino().clone(), _nextQueue.get(0).clone(), best_turn, best_move);
		System.out.println(String.format("SAVE took %,d", (System.nanoTime() - time)));
